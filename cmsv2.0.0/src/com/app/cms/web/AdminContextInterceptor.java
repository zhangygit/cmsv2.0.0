...
import static com.app.core.action.front.LoginAct.RETURN_URL;
...
import com.app.common.web.session.SessionProvider;
import com.app.common.web.springmvc.MessageResolver;
import com.app.core.manager.AuthenticationMng;
...
public class AdminContextInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(null != cmsConfig){
			request.setAttribute(AdminInterceptorConstants.CMS_CONFIG_PATH, cmsConfig.getContextPath());
			request.setAttribute(AdminInterceptorConstants.CMS_CONFIG_PORT, cmsConfig.getPort());
		}else{
			request.setAttribute(AdminInterceptorConstants.CMS_CONFIG_PATH, "/cms");
			request.setAttribute(AdminInterceptorConstants.CMS_CONFIG_PORT, "80");
		}
		// 此时用户可以为null
