package com.app.cms.web;

import static com.app.cms.Constants.RES_PATH;
import static com.app.cms.Constants.TPLDIR_COMMON;
import static com.app.cms.Constants.TPLDIR_STYLE_LIST;
import static com.app.cms.Constants.TPLDIR_TAG;
import static com.app.cms.Constants.TPL_STYLE_PAGE_CHANNEL;
import static com.app.cms.Constants.TPL_SUFFIX;
import static com.app.common.web.Constants.MESSAGE;
import static com.app.common.web.Constants.UTF8;
import static com.app.common.web.ProcessTimeFilter.START_TIME;
import static com.app.common.web.freemarker.DirectiveUtils.PARAM_TPL_SUB;
import static com.app.core.action.front.LoginAct.PROCESS_URL;
...
public class FrontUtils {
	 ...
	 * 系统公共资源路径
	 */
	public static final String RES_COMMON_TPL = "resCommon";
	/**
	 * 模板资源路径
	 */
	 ...
	 * 网站server
	 */
	public static final String SITE_SERVER = "server";
	...
	public static void frontData(HttpServletRequest request,
		...
		map.putAll(RequestUtils.getQueryParams(request));
		map.putAll(RequestUtils.getAttributesMap(request));
		map.put("RequestParameters", RequestUtils.getQueryParams(request));
		CmsUser user = CmsUtils.getUser(request);
		String location = RequestUtils.getLocation(request);
		Long startTime = (Long) request.getAttribute(START_TIME);
		map.put("vfu", new VerifyUtil());
		map.put("session_id", request.getSession().getId());
		map.put("base_url", request.getScheme() + "://" + request.getServerName() + ":"
	...
	public static void frontData(HttpServletRequest request,Map<String, Object> map, CmsSite site,
		...
		String res = ctx + RES_PATH + "/" + site.getPath() + "/"
				+ site.getTplSolution();
		String resCommon = ctx + Constants.RES_COMMON_PATH;
		// res路径需要去除第一个字符'/'
		map.put(RES_TPL, res.substring(1));
		map.put(RES_COMMON_TPL, resCommon.substring(1));
	...
	public static void frontData(Map<String, Object> map, CmsSite site,
		...
		map.put("VERSION", AppVersion.get());
		map.put(SITE, site);
		String ctx = site.getContextPath() == null ? "" : site.getContextPath();
		map.put(BASE, ctx);
		map.put(RES_SYS, ctx + RES_PATH);
