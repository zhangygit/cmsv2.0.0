...
import com.app.cms.manager.main.CmsModelItemMng;
import com.app.cms.manager.main.CmsModelMng;
import com.app.cms.manager.main.CmsSiteMng;
...
import com.app.common.util.StrUtils;
...
import com.app.core.manager.DbFileMng;
	...
	public String uploadMedia(
		...
		try {	
			...
			fileUrl = ftp.storeByExt(site.getUploadPath(), ext, file
				...
				fileUrl = fileRepository.storeByExt4Veido(site.getUploadPath(),
						ext, file);
			}
