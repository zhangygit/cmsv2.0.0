...
import static com.app.common.web.Constants.INDEX;
import static com.app.common.web.Constants.SPT;
...
import com.app.cms.entity.main.base.BaseChannel;
import com.app.cms.staticpage.StaticPageUtils;
import com.app.common.constants.CmsSiteConstants;
import com.app.common.hibernate3.HibernateTree;
import com.app.common.hibernate3.PriorityComparator;
import com.app.common.hibernate3.PriorityInterface;
...
public class Channel extends BaseChannel implements HibernateTree<Integer>,
	...
	public String getUrlDynamic(Boolean whole) {
		...
		//开启子文根时添加子文根（网站路径(path)）
		if(CmsSiteConstants.IS_OPEN_SON_INDEX_PATH){
			url.append(SPT).append(site.getPath());
		}
		url.append(SPT).append(getPath());
		url.append(SPT).append(INDEX);
	...
	/** 
	 * 默认缩略图（遗留问题，后用originalTitleImg获取原图）
	 * @return
	 */
	 ...
	 * @return
	 */
	public String getDefThumbTitleImg() {
		ChannelExt ext = getChannelExt();
		if (ext != null) {
			return ext.getTitleImg();
		} else {
	 ...
	 * @return
	 */
	public String getMinThumbTitleImg() {
		ChannelExt ext = getChannelExt();
		if (ext != null) {
			return FileRepository.getMinThumb(ext.getTitleImg());
		} else {
			return null;
		}
	}
	 ...
	 * @return
	 */
	public String getMaxThumbTitleImg() {
		ChannelExt ext = getChannelExt();
		if (ext != null) {
			return FileRepository.getMaxThumb(ext.getTitleImg());
		} else {
			return null;
		}
	}
	 ...
	 * @return
	 */
	public String getOriginalTitleImg() {
		ChannelExt ext = getChannelExt();
		if (ext != null) {
			return FileRepository.getOriginalImg(ext.getTitleImg());
		} else {
			return null;
		}
	}
	...
	public Channel(java.lang.Integer id,
			...
			com.app.cms.entity.main.CmsModel model, java.lang.Integer lft,
