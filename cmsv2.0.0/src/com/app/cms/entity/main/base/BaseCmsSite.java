...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.app.cms.entity.main.CmsConfig config,
	...
	// many to one
	private com.app.core.entity.Ftp uploadFtp;
	private com.app.cms.entity.main.CmsConfig config;
	 ...
	 */
	public com.app.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.app.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.app.cms.entity.main.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.app.cms.entity.main.CmsConfig config) {
		this.config = config;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.app.cms.entity.main.CmsSite)) return false;
		else {
			com.app.cms.entity.main.CmsSite cmsSite = (com.app.cms.entity.main.CmsSite) obj;
