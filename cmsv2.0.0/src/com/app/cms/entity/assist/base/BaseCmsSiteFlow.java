...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.app.cms.entity.assist.CmsSiteFlow)) return false;
		else {
			com.app.cms.entity.assist.CmsSiteFlow cmsSiteFlow = (com.app.cms.entity.assist.CmsSiteFlow) obj;
