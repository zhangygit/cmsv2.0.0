...
import static com.app.cms.action.front.DynamicPageAct.TPL_INDEX;
...
import com.app.common.web.Constants;
...
public class StaticPageSvcImpl implements StaticPageSvc, InitializingBean {
	...
	@Transactional(readOnly = true)
	public void index(HttpServletRequest request,CmsSite site) throws IOException, TemplateException {
		Map<String, Object> data = new HashMap<String, Object>();
		FrontUtils.frontData(request,data, site, null, site.getUrlStatic(), null);
		String tpl = FrontUtils.getTplPath(tplMessageSource, site
				.getLocaleAdmin(), site.getSolutionPath(), TPLDIR_INDEX,
				TPL_INDEX);
		index(site, tpl, data);
